package com.company.untitled.test_support;

import com.company.untitled.UntitledApplication;
 ...
 */
@SpringBootTest
@UiTest(authenticatedUser = "admin", mainScreenId = "MainScreen", screenBasePackages = "com.company.untitled.screen")
@ContextConfiguration(classes = {UntitledApplication.class, UiTestAssistConfiguration.class})
